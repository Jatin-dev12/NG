...
@Component({
    selector: 'app-notification-saved-searches-dialog',
    templateUrl: './notification-saved-searches-dialog.component.html',
    styleUrls: ['./notification-saved-searches-dialog.component.scss'],
    standalone: true,
    imports: [ReactiveFormsModule, FormSubmitDirective, ControlErrorsDirective, NgxIntlTelInputModule, LaddaDirective]
})
export class NotificationSavedSearchesDialogComponent {
