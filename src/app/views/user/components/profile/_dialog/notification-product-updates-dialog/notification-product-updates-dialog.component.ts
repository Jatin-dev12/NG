...
@Component({
    selector: 'app-notification-product-updates-dialog',
    templateUrl: './notification-product-updates-dialog.component.html',
    styleUrls: ['./notification-product-updates-dialog.component.scss'],
    standalone: true,
    imports: [ReactiveFormsModule, FormSubmitDirective, ControlErrorsDirective, NgxIntlTelInputModule, LaddaDirective]
})
export class NotificationProductUpdatesDialogComponent {
