...
@Component({
    selector: 'app-favorites-vendor',
    templateUrl: './favorites-vendor.component.html',
    styleUrls: ['./favorites-vendor.component.scss'],
    standalone: true,
    imports: [NgxSkeletonLoaderModule, FavoritesItemComponent, PaginationComponent, AsyncPipe]
})
export class FavoritesVendorComponent {
	...
	@Input() params: any = { key: EnumRxKey.User.favorite, roles: Enums.Role.ROLE_VENDORS, sort: 'id', page: 0, size: 20 };
