...
@Component({
    selector: 'app-mktg-inner-page-ad-form',
    templateUrl: './mktg-inner-page-ad-form.component.html',
    styleUrls: ['./mktg-inner-page-ad-form.component.scss'],
    standalone: true,
    imports: [FileDragDropUploaderComponent, NgbDatepicker, RouterLink]
})
export class MktgInnerPageAdFormComponent {
