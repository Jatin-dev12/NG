...
@Component({
    selector: 'app-mktg-featured-ad-availability',
    templateUrl: './mktg-featured-ad-availability.component.html',
    styleUrls: ['./mktg-featured-ad-availability.component.scss'],
    standalone: true,
    imports: [NgbPopover, ReactiveFormsModule, NgbInputDatepicker, OrderPipe]
})
export class MktgFeaturedAdAvailabilityComponent {
