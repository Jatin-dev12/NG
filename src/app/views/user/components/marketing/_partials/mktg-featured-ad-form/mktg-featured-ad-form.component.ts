...
@Component({
    selector: 'app-mktg-featured-ad-form',
    templateUrl: './mktg-featured-ad-form.component.html',
    styleUrls: ['./mktg-featured-ad-form.component.scss'],
    standalone: true,
    imports: [RouterLink, NgbDatepicker]
})
export class MktgFeaturedAdFormComponent {
