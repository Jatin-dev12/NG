...
@Component({
    selector: 'app-mktg-featured-profile-ad-availability',
    templateUrl: './mktg-featured-profile-ad-availability.component.html',
    styleUrls: ['./mktg-featured-profile-ad-availability.component.scss'],
    standalone: true,
    imports: [NgbPopover, ReactiveFormsModule, NgbInputDatepicker, OrderPipe]
})
export class MktgFeaturedProfileAdAvailabilityComponent {
