...
@Component({
    selector: 'app-bill-form-manager',
    templateUrl: './bill-form-manager.component.html',
    styleUrls: ['./bill-form-manager.component.scss'],
    standalone: true,
...
export class BillFormManagerComponent {
