...
import { IssuedListingItemComponent } from '../issued-listing-item/issued-listing-item.component';
...
@Component({
    ...
    standalone: true,
    imports: [RouterLink, ReactiveFormsModule, FormsModule, NgxSkeletonLoaderModule, IssuedListingItemComponent, PaginationComponent, AsyncPipe]
})
export class IssuedListingComponent {
